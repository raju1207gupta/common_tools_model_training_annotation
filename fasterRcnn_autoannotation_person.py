...
path  = 'D:/deeplearning learn/Social distancing/face-mask-detector/dataset_HUL_annotate4_person/'
...
cap = cv2.VideoCapture("rtsp://admin:G#i@l@2019@10.66.0.115:554/cam/realmonitor?channel=10&subtype=0")
...
while cap.isOpened() :
    ...
    if frmnumber%60==0:
        ...
        idxs = cv2.dnn.NMSBoxes(boxes, confidences, 0.65, 0.7)
